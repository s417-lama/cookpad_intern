$(function() {
    ...
    $.get("/api/posts/"+post_id, function(data) {
        ...
        $.get("/api/users/"+post.user_id, function(data2) {
            var user = data2.data;
            $(".postCard__head__info__name").text(user.username);
            ...
            $(".postCard__cont__text").html('<span class="bold">'+user.userid+'</span> '+post.description);
                    ...
                    $(".postCard__comment").append('\
                        <li class="postCard__comment__item">\
                            ...
                            <div class="postCard__comment__item__cont">\
                                <span class="userId">'+comment_user.userid+'</span> '+comment.text+'\
